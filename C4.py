...
class Board:
   ...
   def draw(self): 
      ...
      for i in range(10, 90, 10):
         print(self.gameboard[i+1], self.gameboard[i+2], self.gameboard[i+3], self.gameboard[i+4], self.gameboard[i+5], self.gameboard[i+6], self.gameboard[i+7], self.gameboard[i+8]);
...
class ConnectFour:
   ...
   def bestMoveO(self, lookahead):
      ...
      for i in range(1, 9):
         ...
         if (copyGame.Grid.isLegal(i)):
             ...
             decisionvalue = bestGuess(copyGame, lookahead, -10, 10)
   ...
   #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   def Omove(self):
      # Grid.makeMove('O', self.bestMoveO(self.diffO)) 
